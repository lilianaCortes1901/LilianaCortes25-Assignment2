...
public class kSorting {
    public static void main(String[] args){
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("k_Sorting_report.txt"))){
            writer.write("K Sorting Algorithm Performance Report\n");
            ...
            for(int i = 0; i < performSorting.length; i++){
                    ...
                    writer.write("K Sorting algorithm - " + algorithmName + "\n");
